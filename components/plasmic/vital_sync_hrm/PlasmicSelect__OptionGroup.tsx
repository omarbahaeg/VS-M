...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: lu-ZcZiA6mXy/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: emalQdNAiu4w/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__a9L2A)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__iFbmj)}
              />
            </React.Fragment>
          ),
          value: args.children
