...
import sty from "./PlasmicSidebarNavigationItem.module.css"; // plasmic-import: ZuuWfkNiYXry/css

import Icon4Icon from "./icons/PlasmicIcon__Icon4"; // plasmic-import: -hHWm0myDKZV/icon

createPlasmicElementProxy;

export type PlasmicSidebarNavigationItem__VariantMembers = {
  showBadge: "showBadge";
  collapsed: "collapsed";
  active: "active";
};
export type PlasmicSidebarNavigationItem__VariantsArgs = {
  showBadge?: SingleBooleanChoiceArg<"showBadge">;
  collapsed?: SingleBooleanChoiceArg<"collapsed">;
  active?: SingleBooleanChoiceArg<"active">;
};
type VariantPropType = keyof PlasmicSidebarNavigationItem__VariantsArgs;
export const PlasmicSidebarNavigationItem__VariantProps =
  new Array<VariantPropType>("showBadge", "collapsed", "active");

export type PlasmicSidebarNavigationItem__ArgsType = {
  label?: React.ReactNode;
  icon?: React.ReactNode;
  pageLink?: string;
  openInNewTab?: Target;
};
type ArgPropType = keyof PlasmicSidebarNavigationItem__ArgsType;
export const PlasmicSidebarNavigationItem__ArgProps = new Array<ArgPropType>(
  "label",
  "icon",
  "pageLink",
  "openInNewTab"
...
export type PlasmicSidebarNavigationItem__OverridesType = {
...
export interface DefaultSidebarNavigationItemProps {
  label?: React.ReactNode;
  icon?: React.ReactNode;
  pageLink?: string;
  openInNewTab?: Target;
...
function PlasmicSidebarNavigationItem__RenderFunc(props: {
  variants: PlasmicSidebarNavigationItem__VariantsArgs;
  args: PlasmicSidebarNavigationItem__ArgsType;
  overrides: PlasmicSidebarNavigationItem__OverridesType;
  forNode?: string;
}) {
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicSidebarNavigationItem__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicSidebarNavigationItem__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicSidebarNavigationItem__ArgsType,
      ReservedPropsType
    > &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicSidebarNavigationItem__ArgProps,
          internalVariantPropNames: PlasmicSidebarNavigationItem__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicSidebarNavigationItem__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "menuItem") {
    func.displayName = "PlasmicSidebarNavigationItem";
  } else {
    func.displayName = `PlasmicSidebarNavigationItem.${nodeName}`;
  }
  return func;
}

export const PlasmicSidebarNavigationItem = Object.assign(
  // Top-level PlasmicSidebarNavigationItem renders the root element
  makeNodeComponent("menuItem"),
  {
    ...
    // Metadata about props expected for PlasmicSidebarNavigationItem
    internalVariantProps: PlasmicSidebarNavigationItem__VariantProps,
    internalArgProps: PlasmicSidebarNavigationItem__ArgProps
  }
);

export default PlasmicSidebarNavigationItem;
/* prettier-ignore-end */
