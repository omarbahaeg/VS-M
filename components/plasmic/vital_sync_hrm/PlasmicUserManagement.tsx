          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <Button
                    className={classNames("__wab_instance", sty.button__rO2GA)}
                    color={"green"}
                    shape={"rounded"}
                    showStartIcon={true}
                    size={"compact"}
                            ...
                            >
                              {(() => {
                                const child$Props = {
                                  ...
                                  data: (() => {
                                    try {
                                      return $queries.user.data.response;
                                    } catch (e) {
                                      if (
