...
import sty from "./PlasmicButton.module.css"; // plasmic-import: JRPPbMhYptfo/css
    ...
    <Stack__
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootcolor_clear_showEndIcon]:
      ...
      {(
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__t8LvX)}
                role={"img"}
              />
            ),
      ...
      >
        {renderPlasmicSlot({
          ...
          className: classNames(sty.slotTargetChildren, {
            ...
            [sty.slotTargetChildrencolor_clear_showEndIcon]:
              hasVariant($state, "showEndIcon", "showEndIcon") &&
              hasVariant($state, "color", "clear"),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon19Icon
                className={classNames(projectcss.all, sty.svg___42YOg)}
                role={"img"}
              />
            ),
