...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: ca9OvSNLUBNw/css
  ...
  const args = React.useMemo(
    () =>
      Object.assign(
        {
          placeholder:
            $translator?.("Enter something\u2026") ?? "Enter something\u2026"
        },
        Object.fromEntries(
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg___9O25W)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__eKtMf)}
              role={"img"}
            />
          ),
