...
export type Svgexport36SvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function Svgexport36SvgIcon(props: Svgexport36SvgIconProps) {
...
export default Svgexport36SvgIcon;
/* prettier-ignore-end */
