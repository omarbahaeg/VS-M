...
export type ColumnHeightSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function ColumnHeightSvgIcon(props: ColumnHeightSvgIconProps) {
...
export default ColumnHeightSvgIcon;
/* prettier-ignore-end */
