...
export type DownCircleSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function DownCircleSvgIcon(props: DownCircleSvgIconProps) {
...
export default DownCircleSvgIcon;
/* prettier-ignore-end */
